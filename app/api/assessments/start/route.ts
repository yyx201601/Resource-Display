import { startAttempt } from "@/lib/assessments/assessment-module";
import { AssessmentError, assessmentErrorResponse } from "@/lib/assessments/errors";
import { parseStartAssessmentInput } from "@/lib/assessments/validation";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await startAttempt(parseStartAssessmentInput(body));
